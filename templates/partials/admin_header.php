...
<head>
    ...
    <title><?= htmlspecialchars($page_title ?? 'MedTrack') ?></title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css">
    <link rel="stylesheet" href="../css/style.css">
</head>
<body class="page-doctor-area page-admin-area <?= htmlspecialchars($body_class ?? '') ?>">

<header>
    <div class="logo">
        <a href="dashboard.php">
            <img src="../images/logo-with-label.png" alt="MedTrack Logo" class="logo-img">
        </a>
    </div>
    <nav>
